...
namespace Cycle1gui
{
    public partial class GameScreen : Form
    {
        ...
        public GameScreen(Student selectedUser)
        {
            InitializeComponent();
            ...
            thisGame = selectedUser.getnextGame();
        ...
        int correctSet;//number of the correct set from the admin settings
        List<int> problems1;//first set of terms
        
        List<int> problems2;//2nd set of terms
        int operationSet;//will determine what operation is to be used
        List<bool> answers = new List<bool>();
        string textboxAnswer;
        bool ynAnswer;
        List<int> questionTime;//records the seconds it takes for a user to complete a question
